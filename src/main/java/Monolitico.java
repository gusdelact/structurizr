...
public class Monolitico {
	...
	Container mainframe = sistema.addContainer("Mainframe", "", "");

	Component interfaz = mainframe.addComponent("Interfaz de usuario", "", "");
        Component logica = mainframe.addComponent("Logica", "", "");
	Component persistencia = mainframe.addComponent("Persistencia", "", "");
